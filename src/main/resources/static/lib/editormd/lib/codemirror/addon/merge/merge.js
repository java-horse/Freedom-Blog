...
(function(mod) {
  ...
  function syncScroll(dv, type) {
    ...
    // Don't take action if the position of this markdown was recently set
  ...
  // Updating the marks for markdown content
  ...
  // Updating the gap between markdown and original
